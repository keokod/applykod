    ...
    static function routage($get_id_page) {
        ...
        switch ($get_id_page) {
            ...
            case 2://menu principal
                header('Location: ../app/page_client.php');
                break;
            //1XXX page client 
            case 1000:
            ...
            case 5002:
                ...
                break;
            case 5003:
                header('Location: ../magasin/list_piece.php');
                break;
            ...
            case 6003:
                ...
                break;
            case 6004:
                $id_affaire_tech =  $_SESSION['visiteur']->getMemNextAction() ;
                $crypt = $_SESSION['visiteur']->getCrypt() ;
              //  echo '<a href="../technique/fiche_intervention.php?id_affaire_tech=39&crypt=90eeaa8a6818cabef5b1829f87cd2d5ca9b0be14"> ici </a>';
           header('Location: ../technique/fiche_intervention.php?id_affaire_tech='.$id_affaire_tech.'&crypt='.$crypt.'');
                break;
            
            case 6005:
                
           header('Location: ../magasin/voir_panier.php');
                break;
